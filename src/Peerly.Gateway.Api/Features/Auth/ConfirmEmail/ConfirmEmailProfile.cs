...
public sealed class ConfirmEmailProfile : Profile
{
    public ConfirmEmailProfile()
    {
        ...
        CreateMap<V1ConfirmEmailResponse, Result<ConfirmEmailCommandResponse>>();
        CreateMap<V1ConfirmEmailResponse.Types.Success, ConfirmEmailCommandResponse>(MemberList.Source);
    }
}
